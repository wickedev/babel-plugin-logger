...
var safeJsonStringify = function (data, replacer, space, opts) {
...
// @ts-ignore
var index = lib_1(function (api, options, dirname) {
    return {
        visitor: {
            Function: function (path, state) {
                lib$1.mkdirpSync('./log');
                lib$1.writeFileSync('./log/visitor.log', "path: " + path + ", state: " + safeJsonStringify(state, null, 4));
            },
        },
    };
});
